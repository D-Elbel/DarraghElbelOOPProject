...
public class Motorcycle implements Serializable {
     ...
     * for the object.
     * @param vin passed to setVin() method
     */
     ...
     * @param countryOfOrigin sets country of origin
     */
     ...
     * @param odometer sets odometer value
     */
     ...
     * @param modelName sets model name
     */
     ...
     * @param manufacturer sets manufacturer
     */
     ...
     * @param engineDisplacement sets engine displacement as an int
     */
     ...
     * @param engineType sets the engine type
     */
     ...
     * @param yearCode sets year code int
     */
     ...
     * @param serviceHistory sets year code int
     */
     ...
     * @param partList sets year code int
     */
    ...
    /**
     * Method to get the value of attribute manufacturer
     * @return a string containing a Motorcycle's VIS
     */
    ...
    /**
     * Method to set Motorcycle's VIS number
     * @param vis is a VIS number
     */
     ...
     * @param partToAdd is a new Part object to add
     */
     ...
     * @param serviceToAdd is a new Service object to add
     */
